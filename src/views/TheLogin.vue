  ...
  <div class="login-container">
    <el-form :model="ruleForm2" :rules="rules2"
      ...
      <el-form-item prop="password">
        <el-input :type="pwdType" v-model="ruleForm2.password" auto-complete="off" placeholder="密码">
          <template slot="prepend"><span class="fa fa-lock fa-lg" style="width: 13px"></span></template>
          <template slot="suffix"><span class="password-eye" @click="showPassword" :class="eyeType" style="line-height: 0.75em;"></span></template>
        </el-input>
